...
class FiltroOrden extends HookWidget {
  final ColumnsCategoriaType ordenamiento;
  final ValueChanged<ColumnsCategoriaType> onOrdenamientoChanged;
  ...
  final columnNames = ColumnsCategoriaType.values;

  List<DropdownMenuEntry<ColumnsCategoriaType>> get _dropdownItems {
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownMenuBase<ColumnsCategoriaType>(
      label: 'Ordenar por',
      ...
      value: ordenamiento,
      onChanged: (value) {
        onOrdenamientoChanged(value ?? ColumnsCategoriaType.nombre);
      },
    );
  }
}
