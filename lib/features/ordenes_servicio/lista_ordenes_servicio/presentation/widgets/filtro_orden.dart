...
class FiltroOrden extends HookWidget {
  final ColumnsOrdenesNames ordenamiento;
  final ValueChanged<ColumnsOrdenesNames> onOrdenamientoChanged;
  ...
  final columnNames = ColumnsOrdenesNames.values;

  List<DropdownMenuEntry<ColumnsOrdenesNames>> get _dropdownItems {
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownMenuBase<ColumnsOrdenesNames>(
      label: 'Ordenar por',
      ...
      value: ordenamiento,
      onChanged: (value) {
        onOrdenamientoChanged(value ?? ColumnsOrdenesNames.fechaCreacion);
      },
    );
  }
}
